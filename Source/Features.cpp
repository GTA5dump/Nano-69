...
void WriteVehicle(std::string name, Vehicle veh) {
	std::string iniPath = "C:\\Nano69\\Ini\\" + name + ".ini";
...
void WritePreset(std::string name, float id, float x, float y, float z, float rotx, float roty, float rotz, Hash model) {
	std::string iniPath = "C:\\Nano69\\Ini\\" + name + ".ini"; //change path
...
bool Features::ControlInfo = true;
...
void Features::DepositToBank()
{
	...
	UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2("Lifix", "Logo", 1, 8, "Nano69", "Recovery", 1, "", 9, 0);
